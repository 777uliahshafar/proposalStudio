...
%\includeonlyframes{current5} % Uncomment this for speed compilation

\title{\#Preferensi Pengunjung terhadap Ruang di Kawasan Waterfront Parepare} \author{Muhammad Uliah Shafar | 21020119420029}
\institute[Lehrstuhl]{
	Name des Lehrstuhls \\
...
\begin{frame}[label=current]{Analisis Tapak} \vspace{4pt}
 	\begin{center}
...
\begin{frame}[label=current5]{Zoning}
	\begin{columns}
		\begin{column}{4cm}
...
\begin{frame}[label=current5]{Sirkulasi}
	\begin{columns}
		\begin{column}{4cm}
...
\begin{frame}[label=current]{Potongan} \vspace{4pt}
 	\begin{center}
...
\begin{frame}[label=current]{Ide Desain}
	\begin{columns}
		\begin{column}{5cm}
			\begin{center}
				\includegraphics[height=5cm]{figures/slope}
			\end{center}
            \end{column}
\only<2->{		\begin{column}{5cm}
			\begin{center}
				\includegraphics[height=5cm]{figures/jog}
			\end{center}
		\end{column}}
	\end{columns}
\end{frame}
...
\only<2->{		\begin{column}{5cm}
			\begin{center}
				\includegraphics[height=5cm]{figures/public}
			\end{center}
            \end{column}}
		\begin{column}{5cm}
			\begin{center}
				\includegraphics[height=5cm]{figures/food}
			\end{center}
		\end{column}
	\end{columns}
\end{frame}
...
\begin{frame}[label=current]
 	\begin{center}
		\includegraphics[width=.9\textwidth]{figures/sp}\newline
		{\tiny \textcolor{digiPH_darkblue}{Siteplan \href{https://creativecommons.org/licenses/by/3.0/at/}{CC BY}}}
	\end{center}
\end{frame}
...
\begin{frame}[label=current]
 	\begin{center}
		\includegraphics[width=\textwidth]{figures/bb}\newline
	\end{center}
\end{frame}
...
\begin{frame}[label=current]
 	\begin{center}
		\includegraphics[width=\textwidth]{figures/cc}\newline
	\end{center}
\end{frame}
